...
export const MOCK_SALES: Sale[] = [
  { id: "sale_1", productId: "prod_2", customerId: "cust_1", customerName: "Alice Johnson", productName: "Stainless Steel Watch", quantity: 1, pricePerUnit: 129.99, total: 129.99, date: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() },
  { id: "sale_2", productId: "prod_4", customerId: "cust_2", customerName: "Bob Williams", productName: "Silk Tie", quantity: 2, pricePerUnit: 29.99, total: 59.98, date: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString() },
  { id: "sale_3", productId: "prod_5", customerName: "Walk-in Customer", productName: "Wool Scarf", quantity: 1, pricePerUnit: 39.99, total: 39.99, date: new Date().toISOString() },
];
